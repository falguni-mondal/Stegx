                ...
                <div className="scroll-mt-24 mb-20" id="tech">
                    ...
                    <ul className='pl-5'>
                        <li className='paragraph mb-2 mt-4 flex items-center gap-1'>
                            <FaReact className='text-[#63b9ff] text-[7.6vw] lg:text-[1.15vw]' />React.js – Used to build a dynamic and responsive user interface with a component-based architecture.
                        </li>
                        <li className='paragraph mb-2 flex items-center gap-1'>
                            <TbBrandVite className='text-amber-400 text-[7.6vw] lg:text-[1.15vw]' />Vite – Provided a lightning-fast development environment and optimized build system for React.
                        </li>
                        <li className='paragraph mb-2 flex items-center gap-1'>
                            <RiTailwindCssFill className='text-[#63b9ff] text-[8.6vw] lg:text-[1.15vw]' />Tailwind CSS – Enabled rapid UI styling with a utility-first approach, ensuring a clean and responsive design across devices.
                        </li>
                        <li className='paragraph flex items-center gap-1'>
                            <MdAltRoute className='text-red-400 text-[8.6vw] lg:text-[1.15vw]' />React-router-dom - To handle client-side routing in React applications, allowing for the creation of Single Page Applications (SPAs)
                        </li>
                    </ul>
                    ...
                    <ul className='pl-5'>
                        <li className='paragraph mb-2 mt-4 flex items-center gap-1'>
                            <FaNodeJs className='text-lime-300 text-[7.6vw] lg:text-[1.15vw]' />Node.js – Served as the runtime environment for handling server-side logic and asynchronous operations.
                        </li>
                        <li className='paragraph flex items-center gap-1'>
                            <SiExpress className='text-teal-400 text-[8.6vw] lg:text-[1.15vw]' />Express.js – A minimalist web framework used to create the backend API endpoints for encryption and image handling.
                        </li>
                    </ul>
                    ...
                    <ul className='pl-5'>
                        <li className='paragraph mb-2 mt-4 flex items-center gap-1'>
                            <RiImageCircleAiFill className='text-blue-400 text-[9.6vw] lg:text-[1.15vw]' />Sharp – A fast library, used for manipulating images at the pixel level, allowing the embedding and extraction of hidden messages.
                        </li>
                        <li className='paragraph flex items-center gap-1'>
                            <FaFileImage className='text-indigo-500 text-[7.6vw] lg:text-[1.15vw]' />Multer – Middleware used for handling image file uploads from the client side to the server securely and efficiently.
                        </li>
                    </ul>
                </div>
