...
const Home = () => {
  ...
  return (
    <section className='homepage w-full pt-28 px-10 grid grid-cols-6 gap-16'>
      ...
      {/* MIDDLE SECTION */}
      <div className="service-container neue-txt col-span-2 flex flex-col items-center">
        ...
        <textarea className='w-full bg-[#0000002c] backdrop-blur-lg border-b-2 border-zinc-500 outline-none p-3 resize-none rounded-[5px_5px_0px_0px] text-[#dedede]' rows={5} placeholder='Write your message🤫 / key🔑 here!' name="secret" autoFocus></textarea>

        <div className="actions mt-5">
          <button className='py-2.5 w-[10rem] rounded-lg bg-[#b3b3b3] shadow-2xl shadow-[#8a8a8a] font-medium text-black mr-3'>Retrieve Message</button>
          <button className='py-2.5 w-[10rem] rounded-lg bg-[#7220ff] shadow-2xl shadow-[#491cb3] font-medium text-[#dedede]'>Hide Message</button>
        </div>
      </div>
